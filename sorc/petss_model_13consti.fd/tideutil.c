                              ...
                              int year)
{
   ...
   const IndexLookUpType table[37] = {
      {"M2", 0}, {"O1", 4},  {"S2", 1}, {"N2", 2}, {"K2", 6},
      {"K1", 3}, {"Q1", 10}, {"P1", 5}, {"MF", 34},{"MM", 32},
      {"M4", 11},{"MS4", 21},{"MN4", 30}, {"M6", 12},{"MK3", 29}, 
      {"S4", 23}, {"NU2", 9}, {"S6", 31}, {"MU2", 13}, {"2N2", 8}, 
      {"OO1", 25},{"LAM2", 18}, {"S1", 17},{"M1", 19}, {"J1", 24},
      {"SSA", 16}, {"SA", 14},  {"MSF", 33}, {"RHO", 26},{"T2", 15},
      {"R2", 27}, {"2Q1", 28}, {"2SM2", 35}, {"M3", 22}, {"L2", 7},
      {"2MK3", 36}, {"M8", 20}
   };
   ...
   double xode[37], vpu[37]; /* Storage for nodal factor and equil. arg. */
   ...
   ReadFormatft03 (buffer, 33, 37, &iyr1, xode, vpu);
   fclose (fp);
...
/* Constant angle values and names of tideal constituents.  Order is in
 "Tides and Currents" order. */
   const TideAngleType ang[NUMT] = { {"M2", 28.9841042},  {"O1", 13.9430356},
      {"S2", 30.0000000},  {"N2", 28.4397295},   {"K2", 30.0821373},
      {"K1", 15.0410686},  {"Q1", 13.3986609},   {"P1", 14.9589314},
      {"MF", 1.0980331}, {"MM", 0.5443747}, {"M4", 57.9682084},
      {"MS4", 58.9841042},{"MN4", 57.4238337}
      };
