...
set -x
    ...
    for fle_extf in stormsurge stormtide; do
     ...
     export FORT131=etss.cmc_gec00.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT132=etss.cmc_gep01.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT133=etss.cmc_gep02.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT134=etss.cmc_gep03.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT135=etss.cmc_gep04.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT136=etss.cmc_gep05.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT137=etss.cmc_gep06.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT138=etss.cmc_gep07.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT139=etss.cmc_gep08.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT140=etss.cmc_gep09.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT141=etss.cmc_gep10.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT142=etss.cmc_gep11.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT143=etss.cmc_gep12.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT144=etss.cmc_gep13.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT145=etss.cmc_gep14.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT146=etss.cmc_gep15.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT147=etss.cmc_gep16.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT148=etss.cmc_gep17.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT149=etss.cmc_gep18.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT150=etss.cmc_gep19.t${cyc}z.${fle_extf}.${bsn}.txt
     export FORT151=etss.cmc_gep20.t${cyc}z.${fle_extf}.${bsn}.txt

     export FORT31=${PARMpetss}/model/n_sta_${bsn}

     echo stn_naefs ${cyc} > post_sort_stn_naefs
