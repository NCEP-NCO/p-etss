...
if [ $# -ne 2 ] ; then
  ...
  jmxb1=('440' '364' '886' '257' '745' '229' '280' '165' '241' '524' '429' '400' '251' '314' '200' '381' '89' '173' '190' '200' '100' '215' '169' '225' '118' '330' '135' '189' '301' '350' '191' '211' '149' '362')
   ...
   if [ $RK -lt 34 ] ; then
      ...
      echo exc_naefs ${cyc} > post${DTM}_sort_${fle_ext}.${bsn}
      ...
      echo pro_naefs ${cyc} > post1${DTM}_sort_${fle_ext}.${bsn}
   ...
   export FORT134=fle40${DTM}.cmc_gec00.${fle_ext}.${bsn}
   export FORT135=fle40${DTM}.cmc_gep01.${fle_ext}.${bsn}
   export FORT136=fle40${DTM}.cmc_gep02.${fle_ext}.${bsn}
   export FORT137=fle40${DTM}.cmc_gep03.${fle_ext}.${bsn}
   export FORT138=fle40${DTM}.cmc_gep04.${fle_ext}.${bsn}
   export FORT139=fle40${DTM}.cmc_gep05.${fle_ext}.${bsn}
   export FORT140=fle40${DTM}.cmc_gep06.${fle_ext}.${bsn}
   export FORT141=fle40${DTM}.cmc_gep07.${fle_ext}.${bsn}
   export FORT142=fle40${DTM}.cmc_gep08.${fle_ext}.${bsn}
   export FORT143=fle40${DTM}.cmc_gep09.${fle_ext}.${bsn}
   export FORT144=fle40${DTM}.cmc_gep10.${fle_ext}.${bsn}
   export FORT145=fle40${DTM}.cmc_gep11.${fle_ext}.${bsn}
   export FORT146=fle40${DTM}.cmc_gep12.${fle_ext}.${bsn}
   export FORT147=fle40${DTM}.cmc_gep13.${fle_ext}.${bsn}
   export FORT148=fle40${DTM}.cmc_gep14.${fle_ext}.${bsn}
   export FORT149=fle40${DTM}.cmc_gep15.${fle_ext}.${bsn}
   export FORT150=fle40${DTM}.cmc_gep16.${fle_ext}.${bsn}
   export FORT151=fle40${DTM}.cmc_gep17.${fle_ext}.${bsn}
   export FORT152=fle40${DTM}.cmc_gep18.${fle_ext}.${bsn}
   export FORT153=fle40${DTM}.cmc_gep19.${fle_ext}.${bsn}
   export FORT154=fle40${DTM}.cmc_gep20.${fle_ext}.${bsn}
